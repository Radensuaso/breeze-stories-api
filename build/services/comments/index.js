    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, model_2.default.findById(storyId)];
            case 1:
                story = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                story = _a.sent();
                if (!story) return [3 /*break*/, 3];
                newComment = new model_1.default(__assign(__assign({}, req.body), { story: storyId, author: authorId }));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                authorId = req.author._id;
                commentId = req.params.commentId;
                return [4 /*yield*/, model_1.default.findOneAndUpdate({
                        _id: commentId,
                        author: authorId,
                    }, req.body, { new: true })];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                authorId = req.author._id;
                commentId = req.params.commentId;
                return [4 /*yield*/, model_1.default.findOneAndDelete({
                        _id: commentId,
                        author: authorId,
                    })];
            case 1:
