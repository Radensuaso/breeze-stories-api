...
var randomizeAvatar_1 = __importDefault(require("../../lib/randomizeAvatar"));
...
AuthorSchema.methods.toJSON = function () {
    var authorObject = this.toObject();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, bcrypt_1.default.compare(password, author.password)];
                case 2:
                    isMatch = _a.sent();
                    if (isMatch) {
